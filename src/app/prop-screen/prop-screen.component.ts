  ...
  getTeamStats(team: DbGameBookData, teamName: string){
    ...
    if(propType == 'h2h'){
      ...
      if(team.marketKey == 'h2h'){
        ...
        finalTeam.teamAgainstTotalWins = teamAgainstStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning))).length
        finalTeam.teamAgainstWinsHomeAway = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning)) && e.homeOrAway != homeAway).length
        finalTeam.teamAgainstWinsTeam = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning)) && e.teamAgainstName == MlbService.mlbTeamNameToAbvr[teamName]).length
      }
      else if(team.marketKey == 'h2h_1st_5_innings'){
        finalTeam.totalWins = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning))).length
        finalTeam.totalWinsHomeAway = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning)) && e.homeOrAway == homeAway).length
        finalTeam.totalWinsTeam = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning)) && e.teamAgainstName == teamAgainstName).length
  
        finalTeam.teamAgainstTotalWins = teamAgainstStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning))).length
        finalTeam.teamAgainstWinsHomeAway = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning)) && e.homeOrAway != homeAway).length
        finalTeam.teamAgainstWinsTeam = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning)) && e.teamAgainstName == MlbService.mlbTeamNameToAbvr[teamName]).length
      }
      else if(team.marketKey == 'h2h_1st_7_innings'){
        finalTeam.totalWins = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning))).length
        finalTeam.totalWinsHomeAway = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning)) && e.homeOrAway == homeAway).length
        finalTeam.totalWinsTeam = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning)) && e.teamAgainstName == teamAgainstName).length
  
        finalTeam.teamAgainstTotalWins = teamAgainstStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning))).length
        finalTeam.teamAgainstWinsHomeAway = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning)) && e.homeOrAway != homeAway).length
        finalTeam.teamAgainstWinsTeam = teamGameStats.filter(e => ((e.pointsScoredFirstInning + e.pointsScoredSecondInning + e.pointsScoredThirdInning + e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning) > (e.pointsAllowedFirstInning + e.pointsAllowedSecondInning + e.pointsAllowedThirdInning+ e.pointsScoredFourthInning + e.pointsScoredFifthInning + e.pointsScoredSixthInning + e.pointsScoredSeventhInning)) && e.teamAgainstName == MlbService.mlbTeamNameToAbvr[teamName]).length
      }
