...
export class PropScreenComponent implements OnInit {
  ...
  async displayProp() {
    ...
    this.displayPropHtml1 = ({ name: name1, abvr: abvr, commenceTime: reusedFunctions.convertCommenceTime(team1[0].commenceTime.toString()) });
    ...
    this.displayPropHtml2 = ({ name: name1, abvr: abvr, commenceTime: reusedFunctions.convertCommenceTime(team2[0].commenceTime.toString()) });
  ...
  async getTeamStats(team: DbGameBookData, teamName: string) {
    ...
    try {
      let teamNameAbvr = await TeamInfoController.getTeamInfoByFullName(teamName)
      ...
      let teamAgainstName = teamName == team.homeTeam ? await TeamInfoController.getTeamInfoByFullName(team.awayTeam) : await TeamInfoController.getTeamInfoByFullName(team.homeTeam)
