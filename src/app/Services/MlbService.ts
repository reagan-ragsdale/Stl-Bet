...
export class MlbService {
    ...
    static mlbConvertTeamGameStatsFromApiToDb(gameStats: any, team: string) {
        ...
        var teamStatFinal: DbMlbTeamGameStats = {
            ...
            pointsScoredNinthInning: gameStats.away == team ? gameStats.lineScore.away.scoresByInning[9] : gameStats.lineScore.home.scoresByInning[9],
            ...
            pointsAllowedNinthInning: gameStats.away == team ? gameStats.lineScore.home.scoresByInning[9] :  gameStats.lineScore.away.scoresByInning[9],
