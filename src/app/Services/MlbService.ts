...
export class MlbService {
    ...
    static mlbTeamName = [ "Arizona Diamondbacks", "Atlanta Braves", "Baltimore Orioles", "Boston Red Sox", "Chicago Cubs", "Chicago White Sox", "Cincinnati Reds", "Cleveland Guardians", "Colorado Rockies", "Detroit Tigers", "Houston Astros", "Kansas City Royals", "Los Angeles Angels", "Los Angeles Dodgers", "Miami Marlins", "Milwaukee Brewers", "Minnesota Twins", "New York Mets", "New York Yankees", "Oakland Athletics", "Philadelphia Phillies", "Pittsburgh Pirates", "San Diego Padres", "San Francisco Giants", "Seattle Mariners", "St. Louis Cardinals", "Tampa Bay Rays", "Texas Rangers", "Toronto Blue Jays", "Washington Nationals" ]
    ...
    static async mlbConvertTeamGameStatsFromApiToDb(gameStats: any): Promise<any[] | number> {
        try{
            ...
            var teamStatAway: DbMlbTeamGameStats = {
                ...
                pointsScoredFirstInning: (gameStats.lineScore.away.scoresByInning[1] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[1]),
                pointsScoredSecondInning: (gameStats.lineScore.away.scoresByInning[2] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[2]),
                pointsScoredThirdInning: (gameStats.lineScore.away.scoresByInning[3] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[3]),
                pointsScoredFourthInning: (gameStats.lineScore.away.scoresByInning[4] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[4]),
                pointsScoredFifthInning: (gameStats.lineScore.away.scoresByInning[5] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[5]),
                pointsScoredSixthInning: (gameStats.lineScore.away.scoresByInning[6] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[6]),
                pointsScoredSeventhInning: (gameStats.lineScore.away.scoresByInning[7] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[7]),
                pointsScoredEigthInning: (gameStats.lineScore.away.scoresByInning[8] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[8]),
                ...
                pointsAllowedFirstInning: (gameStats.lineScore.home.scoresByInning[1] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[1]),
                pointsAllowedSecondInning: (gameStats.lineScore.home.scoresByInning[2] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[2]),
                pointsAllowedThirdInning: (gameStats.lineScore.home.scoresByInning[3] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[3]),
                pointsAllowedFourthInning: (gameStats.lineScore.home.scoresByInning[4] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[4]),
                pointsAllowedFifthInning: (gameStats.lineScore.home.scoresByInning[5] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[5]),
                pointsAllowedSixthInning: (gameStats.lineScore.home.scoresByInning[6] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[6]),
                pointsAllowedSeventhInning: (gameStats.lineScore.home.scoresByInning[7] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[7]),
                pointsAllowedEigthInning: (gameStats.lineScore.home.scoresByInning[8] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[8]),
            ...
            var teamStatHome: DbMlbTeamGameStats = {
                ...
                pointsScoredFirstInning: (gameStats.lineScore.home.scoresByInning[1] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[1]),
                pointsScoredSecondInning: (gameStats.lineScore.home.scoresByInning[2] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[2]),
                pointsScoredThirdInning: (gameStats.lineScore.home.scoresByInning[3] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[3]),
                pointsScoredFourthInning: (gameStats.lineScore.home.scoresByInning[4] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[4]),
                pointsScoredFifthInning: (gameStats.lineScore.home.scoresByInning[5] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[5]),
                pointsScoredSixthInning: (gameStats.lineScore.home.scoresByInning[6] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[6]),
                pointsScoredSeventhInning: (gameStats.lineScore.home.scoresByInning[7] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[7]),
                pointsScoredEigthInning: (gameStats.lineScore.home.scoresByInning[8] == "x" ? 0 : gameStats.lineScore.home.scoresByInning[8]),
                ...
                pointsAllowedFirstInning: (gameStats.lineScore.away.scoresByInning[1] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[1]),
                pointsAllowedSecondInning: (gameStats.lineScore.away.scoresByInning[2] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[2]),
                pointsAllowedThirdInning: (gameStats.lineScore.away.scoresByInning[3] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[3]),
                pointsAllowedFourthInning: (gameStats.lineScore.away.scoresByInning[4] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[4]),
                pointsAllowedFifthInning: (gameStats.lineScore.away.scoresByInning[5] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[5]),
                pointsAllowedSixthInning: (gameStats.lineScore.away.scoresByInning[6] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[6]),
                pointsAllowedSeventhInning: (gameStats.lineScore.away.scoresByInning[7] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[7]),
                pointsAllowedEigthInning: (gameStats.lineScore.away.scoresByInning[8] == "x" ? 0 : gameStats.lineScore.away.scoresByInning[8]),
