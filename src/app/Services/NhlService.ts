                    ...
                    for (let i = 0; i < specificProps.length; i++) {
                        try {
                            ...
                            let playerPropObj: PlayerPropDto = {
                                ...
                                fullGameLog: [],
                                trends: [],
                                propTrendLabels: playerPropDataPropTrend.filter(e => e.marketKey == specificProps[i].marketKey && e.playerName == uniquePlayersWithinProp[m] && e.description == specificProps[i].description).map(e => reusedFunctions.formatDateString(e.createdAt!.toUTCString())),
