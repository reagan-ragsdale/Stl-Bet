...
export class NflService {
    ...
    static async convertGameSummaryToDb(gameSummary: any): Promise<any[]> {
        ...
        teamStats.push({
            ...
            passAttempts: Number(gameSummary.teamStats.away.passCompletionsAndAttempts.slice(gameSummary.teamStats.away.sacksAndYardsLost.indexOf('-'))),
        ...
        teamStats.push({
            ...
            passAttempts: Number(gameSummary.teamStats.home.passCompletionsAndAttempts.slice(gameSummary.teamStats.home.sacksAndYardsLost.indexOf('-'))),
