...
const newMlbService = new MlbService
const nreReusedFunctions = new reusedFunctions
...
export const mlbCronFile = async () => {
    ...
    const gamesFromDraftKings = await newDKController.getDatesAndGames("MLB");
    ...
    MlbController.nbaAddPlayerInfoData(allPlayerInfo)
